 ...
 */
export const reassignSellerBulkCtrl = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const reassignDeliveryBulkCtrl = asyncHandler(async (req: Request, res: Response) => {
