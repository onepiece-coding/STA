...
export const addBulkSupplyCtrl = asyncHandler(async (req, res) => {
  const entries: Array<{ productId: string; quantity: number; expiringAt: Date }> = req.body;
 ...
 */
export const lowStockAlertsCtrl = asyncHandler(async (req: Request, res: Response) => {
 ...
 * @access private (admin)
 */
export const expiringSoonAlertsCtrl = asyncHandler(async (req: Request, res: Response) => {
