 ...
 * @access public
----------------------------------------------*/
export const loginUserCtrl = asyncHandler(async (req:Request, res:Response, next:NextFunction) => {
...
export const changePasswordCtrl = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (!currentPassword || !newPassword || !confirmPassword) {
    throw createError(400, 'currentPassword, newPassword, and confirmPassword are required');
  }
  ...
  if (currentPassword === newPassword) throw createError(400, "You entered the same old password");
